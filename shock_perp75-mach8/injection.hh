...
#define DEFINE_INJECTOR(side,dim1,dim2)                            \
  ...
  ALLOCATE(global->e##side,len,double);                            \
...
#define ebot(n,i,j) global->ebot[INDEX_FORTRAN_3(n,i,j,1,nsp,1,nx,1,ny)]
...
#define etop(n,i,j) global->etop[INDEX_FORTRAN_3(n,i,j,1,nsp,1,nx,1,ny)]
...
#define eleft(n,i,j) global->eleft[INDEX_FORTRAN_3(n,i,j,1,nsp,1,nz,1,ny)]
...
#define eright(n,i,j) global->eright[INDEX_FORTRAN_3(n,i,j,1,nsp,1,nz,1,ny)]
