...
void compute_injection(double uv[],  // rel. momentum of injected particles
                       double ne,    // density of boundary cell
                       double vel[], // fluid moentum of boundary cell
                       double p[],   // rel. stress tensor of boundary cell
  ...
  // Cheeck if det is less than zero
 ...
 reject:
  ...
  if (it > itmax){
    MESSAGE((" Convergence Problem in Inector --> error=%",error));
  }
...
#define vth_l(n) global->vth_l[INDEX_FORTRAN_1(n,1,nsp)]
